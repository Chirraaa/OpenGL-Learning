...
private:
    ...
    // NEW: Threading and chunk management members
    ...
    std::mutex m_worldMutex; // Mutex to protect shared data like m_generatingChunks
    std::unordered_set<long long> m_generatingChunks; // Tracks chunks currently being processed by workers

    void chunkWorkerLoop(); // NEW: The function for our worker threads
